...
import { selectRegisterModal } from "../store/selectors/modalSelectors";
import { setRegisterModal } from "../store/actions/modalActions";
...
export default function UserRegistrationModal() {
  ...
  const modal = useAppSelector(selectRegisterModal);
